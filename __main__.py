...
partitions = ImageDatasetBuilder(data_root=args.input_data_root, n_splits=n_splits,
                                 ...
                                 sequence=args.sequence, sample_id=args.sample_id, seed=args.seed).build()

if args.output_format == 'csv':
    CSVWriter(n_splits=n_splits, output_dir=args.output_dir, output_file_name=args.output_file_name)\
        .write(partitions)
elif args.sequence:
    SequenceImageTFRecordsWriter(n_splits=n_splits, output_dir=args.output_dir, output_file_name=args.output_file_name)\
        .write(partitions)
else:
